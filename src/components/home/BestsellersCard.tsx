...
import {toggleFavoriteInBestsellers} from '../../store/slices/productSlice';

const BestsellersCard: React.FC<NewArrivalsCardProps> = ({item}) => {
  ...
  return (
    <Pressable
      ...
      style={newArrivalCardStyles.container}>
      <FastImage
        source={{
          uri: item.image,
...
export default memo(BestsellersCard);
